    ...
    <div className="space-y-6 max-w-4xl w-full  py-12 pt-20 lg:pt-12">
      ...
      <div className="space-y-8">
        ...
        <p className="text-primary text-lg font-light">
          ...
          and hues of the shadows (especially on the skin), and the border from artist&apos;s tape
          on my watercolor portraits. Also all the asian girls look vaguely like my cousin, who
          appears many times in the works I trained on.
        </p>
        <div>
          <Image
            src="/projects/fal.png"
            alt="fal"
            width={1200}
            height={800}
            className="w-full max-w-4xl"
        ...
        <div className="flex flex-row items-center gap-4 justify-between w-full">
          <Image
            src="/projects/letterpainting.png"
            alt="DiffusionMe"
            width={400}
            height={400}
            className="w-1/2"
          />
          <Image
            src="/projects/letterpaintingai.png"
            alt="DiffusionMe"
            width={400}
            height={400}
            className="w-1/2"
        ...
        <div className="flex flex-row items-center gap-4 justify-between w-full">
          ...
          />
          <Image
            src="/projects/tearmeapartai.png"
            alt="DiffusionMe"
            width={400}
            height={400}
            className="w-1/2"
        ...
        <div className="flex flex-row items-center gap-4 justify-between w-full">
          <Image
            src="/projects/badgeneration.jpg"
            alt="DiffusionMe"
            width={400}
            height={400}
            className="w-1/2"
          />
          <Image
            src="/projects/badgeneration2.png"
            alt="DiffusionMe"
            width={400}
            height={400}
            className="w-1/2"
        ...
        <div className="flex flex-row items-center gap-4 justify-between w-full">
          <Image
            src="/projects/badgeneration3.jpg"
            alt="DiffusionMe"
            width={400}
            height={400}
            className="w-1/2"
