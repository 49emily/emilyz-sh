  ...
  return (
    <div className="space-y-6 max-w-4xl mb-20  py-12 pt-20">
      ...
      <p className="text-lg text-primary ">
        <i>Portrait of You</i> is a series of generative living artworks that
        evolve with digital behavior inspired by Oscar Wilde&apos;s{" "}
        <i>The Picture of Dorian Gray</i>. Each portrait undergoes a
        transformation using a generative AI model at every increment of its
        owner&apos;s unproductive screen time, capturing the gradual erosion of
        identity in the age of distraction. The portraits will reset weekly at
        midnight EST on Sunday, giving each person a new chance at redefining
        themselves in an ongoing public installation of self-surveillance.
      </p>
      <p className="text-lg text-primary ">
        This installation, and its extension for friends of the artists, ran for
        11 weeks from September 21st to December 7th, 2025.
      </p>
