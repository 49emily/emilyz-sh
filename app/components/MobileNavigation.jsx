...
function MobileNavigation() {
  ...
  return (
    <>
        ...
        <div className="w-5 h-5 flex flex-col justify-center items-center space-y-1">
          ...
          <span
            ...
            style={{
              ...
              transform: `scaleX(${isMobileMenuOpen ? 0 : 1})`,
            }}
          ></span>
          <span
            className={`block w-4 h-0.5 bg-secondary transition-all duration-300 ${
      ...
      >
        <div
          className={`absolute top-0 left-0 right-0 w-full max-h-[100dvh] bg-background/90 backdrop-blur-md border-b border-white/20 dark:border-white/10 transform transition-transform duration-250 ease-out overflow-y-auto ${
            isMobileMenuOpen ? "translate-y-0" : "-translate-y-full"
          }`}
          onClick={(e) => e.stopPropagation()}
        >
          <div className="px-6 pb-8 pt-20">
            <nav className="grid grid-cols-2 gap-6 items-start">
              <div className="flex min-w-0 flex-col items-start gap-4">
                <Image
                  ...
                  width={300}
                  height={300}
                  className="w-full max-w-40 object-cover cursor-pointer"
                />

                {/* Social Media Icons */}
                <div className="flex w-full max-w-40 justify-between gap-2">
                  <a
