            ...
            <nav>
              <div className="flex flex-col items-center gap-4 mb-8">
                <Image
                  ...
                  width={300}
                  height={300}
                  className="w-40 max-w-[60vw] object-cover cursor-pointer"
                />

                {/* Social Media Icons */}
                <div className="flex space-x-6 justify-between w-40 max-w-[60vw] ">
                  <a
                ...
                {navItems.map((item) => (
                  <div key={item.path} className="relative">
                    <Link
                      ...
                      className={`nav-link block text-2xl transition-colors duration-200 hover:text-primary ${
