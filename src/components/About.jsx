    ...
    <div className="my-auto mx-auto max-w-2xl relative">
      <div className="text-2xl tracking-tight">
        ...
        <ul className="list-decimal list-inside space-y-1">
          <li>Was raised in between China and Denver, Colorado by my grandparents and parents.</li>
          <li>
            Graduated from my CS and <span className="link">Art Practice</span> undergrad degree at
            Stanford in 2.5 years.
          </li>
          <li>
            Interned at{" "}
          ...
          <li>
            Joined fellowships like <span className="link">Neo Scholars</span> and Pear Garage that
